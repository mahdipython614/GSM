...
class CefBrowser(Widget):
    ...
    def __init__(self, start_url="file://" + GetApplicationPath("testMaps.html"), **kwargs):
...
class ClientHandler:
    ...
    def _fix_select_boxes(self, frame):
        ...
        if not os.path.exists(resources_dir):
            print("The kivy-select-boxes directory does not exist, select boxes fix won't be applied.")
            return
